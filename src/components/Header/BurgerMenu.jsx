...
const BurgerMenu = () => {
  ...
  return (
      <div>
          <div
              className={`w-[38px] h-6 cursor-pointer flex flex-col justify-between items-center relative z-10`}
              onClick={() => setIsClick(!isClick)}
          >
              <div
                  className={`w-full h-1 bg-slate-200 rounded-md transform transition-transform duration-300 ease-in-out ${
