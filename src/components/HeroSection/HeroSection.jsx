...
const HeroSection = () => {
  ...
  return (
    <section className="relative overflow-hidden  bg-background min-h-[86.666] flex justify-center sm:text-center py-16 sm:py-20">
      ...
      <div className="mx-auto relative container px-4 sm:px-6 lg:px-8 sm:text-center">
        <div className="relative max-w-4xl mx-auto">
          ...
          <motion.p className="mb-6 sm:mb-8 font-bricolage text-lg sm:text-xl md:text-2xl text-text mx-auto max-w-3xl">
