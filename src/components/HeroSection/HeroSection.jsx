...
const HeroSection = () => {
  return (
    <section
      className="min-h-[100vh] flex justify-center items-center h-screen text-[#FFFFFF] font-roboto py-12  bg-radial-blue "
    ...
    >
      <Container>
        <div className="text-center">
          ...
          <p className="sm:text-2xl mb-8 max-w-2xl mx-auto text-[18px] text-2xl">
            {" "}
