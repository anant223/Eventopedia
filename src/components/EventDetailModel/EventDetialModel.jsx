...
const EventDetialModel = ({
  ...
  return (
    <div className=" relative inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center p-4 shadow-2xl m-auto">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col justify-center">
