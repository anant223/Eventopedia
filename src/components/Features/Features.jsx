...
const Features = () => {
  return (
    <section className=" bg-[#F5F5F7] text-gray font-roboto">
      <div className="">
        ...
        <div className="relative w-full group pl-4 sm:pl-44">
          <div className="absolute left-0 top-1/2 -translate-y-1/2 z-10 hover:bg-gray-200 rounded-full p-2  opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:duration-300 hover:transition ">
