        ...
        <div className="flex flex-col space-y-8 justify-center">
          ...
          <div className=" grid grid-cols-2 items-center mb-8 ">
            {howitwork.map((item, index) => (
              <div key={index} className={`py-4 ${index === 2 ? "col-span-2":"" }`}>
                <div className=" flex flex-col items-center">
                  ...
                  <h4 className="sm:text-2xl font-semibold mb-6 text-xl">{item.title}</h4>
                  <p className="text-white sm:text-base text-center">{item.description}</p>
                </div>
              </div>
            ))}
          </div>
