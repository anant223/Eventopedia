...
const EventSidebar = () => {
  ...
  return (
    <aside className="min-h-screen bg-gray-800 border-r-[0.1px] border-gray-700 text-white top-16 z-30 fixed inset-0 font-roboto max-w-64 left-0 transition-transform -translate-x-full sm:translate-x-0">
            ...
            {sidebarMenuItems.map((item) => (
              <li key={item.label} className="">
                ...
                >
                  ...
                  <span className="ms-3 text-xl">{item.label}</span>
                </button>
              </li>
            ))}
          </ul>
